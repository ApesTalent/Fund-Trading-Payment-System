...
export default function ThirdForm(props) {
  ...
  const toNext = () => {
    if (
      ...
      validator.isEmpty(formData.street) ||
      validator.isEmpty(formData.city) ||
      validator.isEmpty(formData.region) ||
      validator.isEmpty(formData.zipCode) ||
      validator.isEmpty(formData.country)
    ) {
      ...
      if (
        validator.equals(
          ...
          accountTypes.CRYPTOCURRENCY_WALLET
        )
      ) {
        next2Step();
      } else {
      ...
      <Card mb={{ base: "0px", lg: "20px" }} align="center">
        ...
        <InputGroup w={{ base: "100%" }} mt="15px">
          ...
          <Input
            ...
            borderRadius={"10px"}
            placeholder={
              formData.accountType === accountTypes.BANK_INDIVIDUAL
                ? "Legal First Name"
                : formData.accountType === accountTypes.BANK_COMPANY
                ? "Company Name"
                : "Wallet Owner's Name"
            }
            onChange={(e) =>
        ...
        {formData.accountType === "Bank Owned by Individual" && (
          <InputGroup w={{ base: "100%" }} mt="15px">
            <InputLeftElement
              children={
                <IconButton
          ...
          <InputLeftElement
            children={
              <IconButton
                ...
                icon={
                  <MdOutlineLocationOn color={IconColor} w="15px" h="15px" />
                }
              ></IconButton>
            }
          />
